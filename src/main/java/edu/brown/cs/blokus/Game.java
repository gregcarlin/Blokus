...
public class Game {
  ...
  private boolean firstMove(Turn turn) {
    return players.get(turn).getRemainingPieces().size() == Shape.NUM_SHAPES;
  }
   ...
   *
   * @return the number of milliseconds elapsed between the epoch and the last
   * turn
   */
  ...
  public static void main(String[] args) {
    ...
    Game g = new Game.Builder()
      .setBoard(b)
      .setPlayer(Turn.FIRST, new Player("", allShapes, 1, true))
      .setPlayer(Turn.SECOND, new Player(""))
      .setPlayer(Turn.THIRD, new Player(""))
      .setPlayer(Turn.FOURTH, new Player(""))
      .setTurn(Turn.FIRST)
